	...
	<div class="container">
        ...
        <div class="col-md-2"> &nbsp; </div>
            ...
            <label>How would you like us to contact <input type="text" class="gitit second" placeholder="them?" disabled></label>
                        ...
                        <div class="row"> 
                <div class="col-xs-4 nopadding text-center"><button type="button" class="btn btn-primary btn-sm" onClick="MM_showHideLayers('collapseEmail','','show','collapseText','','hide','collapseCall','','hide')">Email</button></div>
                <div class="col-xs-4 nopadding text-center"><button type="button" class="btn btn-primary btn-sm center-text" onClick="MM_showHideLayers('collapseEmail','','hide','collapseText','','show','collapseCall','','hide')">Text/SMS</button></div>
                
                <div class="col-xs-4 nopadding text-center"><button type="button" class="btn btn-primary btn-sm" onClick="MM_showHideLayers('collapseEmail','','hide','collapseText','','hide','collapseCall','','show')">Phone Call</button></div>
                </div>
            </div>
            <div class="col-md-2"> &nbsp; </div>
            </div>
...
<div id="collapseEmail" class="text-left">
